...
aws elasticbeanstalk create-application-version --application-name byuoitav-$PROJECT_NAME --version-label $SHA1 --source-bundle S3Bucket=$EB_BUCKET,S3Key=$DOCKERRUN_FILE
