...
GetIncompatableCommands will return a list of commands that are incompatable (cannot be issued at the same time) as commands generated by the CommandEvaluator. This is available for use in the reconciler.  
